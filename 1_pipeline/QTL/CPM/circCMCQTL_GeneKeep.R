...
phenotype_file_name=basedir%&%"qtl_C/CIRI.JUNCTION.PASS.voom.log.Res.GaucasianID.txt"
...
output_file_name_cis =basedir%&%"qtl_C/GeneKeep/resultCis/cis.chr"%&%chr%&%".txt"
...
write.table(me$cis$min.pv.gene,basedir%&%"qtl_C/GeneKeep/minP/minpvgenesnp.chr"%&%chr%&%".txt",sep="\t",col.names = F,quote = F)
